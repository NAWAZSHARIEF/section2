...
public class AccountsServiceImpl implements IAccountService {
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        customer.setCreatedBy("Nawaz Sharief");
    ...
    public CustomerDto fetchAccount(String mobileNumber) {
       ...
       CustomerDto customerDto = CustomerMapper.mapToCustomerDto(customer.get(),new CustomerDto());
        AccountsDto accountsDto = AccountsMapper.mapToAccountsDto(accounts.get(),new AccountsDto());
    ...
    private Accounts createNewAccount(Customer customer) {
        ...
        Long accountNumber = 10000000000L+new Random().nextInt(90000000);

        newAccount.setCreatedAt(LocalDateTime.now());
        newAccount.setCreatedBy("Nawaz Sharief");
